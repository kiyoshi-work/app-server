...
import { AccountLayout, AccountState, getMint, TOKEN_2022_PROGRAM_ID, TOKEN_PROGRAM_ID } from "@solana/spl-token";
import { Commitment, Connection, GetBalanceConfig, PUBLIC_KEY_LENGTH, PublicKey } from "@solana/web3.js";
    ...
    constructor(
      ...
      async getTokenHoldings(address: string) {
        try {
          ...
          console.log('[getTokenHoldings] [error]: ', e); // console by M-MON
          return [];
        }
      }  

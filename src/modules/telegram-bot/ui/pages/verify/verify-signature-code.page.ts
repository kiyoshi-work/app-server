...
export class VerifySignatureCodePage implements PhotoPage {
  constructor(
  ...
  build(data: { firstName: string }): PhotoResponse {
    ...
    const text = this.i18n.t('start.verify.welcome_message', {
      args: {
        firstName,
      },
      lang: this.lang,
    ...
    const verifySignatureButton = this.i18n.t('start.verify.verify_signature', {
      lang: this.lang,
    });
